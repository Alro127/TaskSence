...
> _"Làm sao bạn đảm bảo code hoạt động đúng khi không có test nào?"_
...
6. _(Mới)_ **Comment Mention System** — real-time notification khi được mention trong comment
7. _(Mới)_ **Sprint Management** — tổ chức task theo sprint cycle
