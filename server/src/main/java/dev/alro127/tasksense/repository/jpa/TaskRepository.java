...
public interface TaskRepository extends JpaRepository<TaskEntity, Long> {
  ...
  @Query("""
      ...
      """)
  List<TaskEntity> findByProjectIdAndTitleExact(@Param("projectId") Long projectId, @Param("title") String title,
      Pageable pageable);
  ...
  @Query("""
          ...
          ORDER BY t.updatedAt DESC, t.id DESC
      """)
  List<TaskEntity> findByProjectIdAndTitleLike(@Param("projectId") Long projectId, @Param("title") String title,
      Pageable pageable);
