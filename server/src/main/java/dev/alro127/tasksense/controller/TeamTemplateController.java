...
public class TeamTemplateController {
        ...
        @GetMapping
        public ResponseEntity<ApiResponse<PageResponse<TeamTemplateResponse>>> getMyTemplates(Pageable pageable) {

                ApiResponse<PageResponse<TeamTemplateResponse>> response = new ApiResponse<>(
                                "200",
                                "Get team templates successfully",
                                teamTemplateService.getMyTemplates(pageable),
                                null);
