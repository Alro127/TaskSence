...
public class CommentServiceImpl implements CommentService {
        ...
        public CommentResponse createComment(CommentCreateRequest request) {
                ...
                eventPublisher.publishEvent(
                                new EntityChangedEvent(EntityType.COMMENT, comment.getId(), Operation.UPSERT));
        ...
        public List<CommentResponse> getComments(Long taskId, Long cursor, int limit) {
                ...
                List<CommentEntity> comments = commentRepository.findComments(taskId, cursor, pageable);
                ...
                Map<Long, List<CommentReactionEntity>> reactionMap = reactionRepository.findByCommentIdIn(commentIds)
                                .stream()
                                .collect(Collectors.groupingBy(r -> r.getComment().getId()));

                Map<Long, List<CommentMentionEntity>> mentionMap = mentionRepository.findByCommentIdIn(commentIds)
                                .stream()
