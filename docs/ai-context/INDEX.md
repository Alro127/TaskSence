...
| ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------- |
| RUN-2026-06-05-005 | 2026-06-05 | Rewrote Docker docs to match `proxy/nginx.conf`, including actual Nginx routes, service names, internal-only health checks, and no Compose edits. | docs/DOCKER_*.md, proxy/nginx.conf, infra/docker/compose.yaml |
| RUN-2026-06-05-004 | 2026-06-05 | Added complete deployment env preparation, updated `.env.example`, documented current compose limitations, and fixed CI build/pull services to match compose image overrides without editing base Compose. | `.env.example`, .github/workflows/main.yml, docs/TASKSENSE_DEPLOYMENT_KT.md |
| RUN-2026-06-05-003 | 2026-06-05 | Aligned deployment KT with actual `infra/docker` source of truth, including networks, volumes, service healthchecks, registry override behavior, and CI mismatch notes. | docs/TASKSENSE_DEPLOYMENT_KT.md                                 |
