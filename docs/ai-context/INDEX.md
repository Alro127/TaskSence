...
| ------------------ | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| RUN-2026-06-02-001 | 2026-06-02 | Implemented AI-Powered Project Template and Interactive Guidance feature across Java backend, Python AI service, and React frontend. | server/ai/client guidance modules + migrations |
...
| RUN-2026-05-12-001 | 2026-05-12 | Added Spring AI MCP facade, safer Agent Mode actions/JWT forwarding, deterministic RAG reranking, MCP wrapper workflow, and visible reasoning UI. | MCP server + ai agent/RAG + client agent UI |
