...
| ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------- |
| RUN-2026-06-05-004 | 2026-06-05 | Added complete deployment env preparation, updated `.env.example`, aligned infra interpolation for DB/frontend env, and fixed CI build/pull services to match compose image overrides. | `.env.example`, infra/docker/compose.yaml, .github/workflows/main.yml, docs/TASKSENSE_DEPLOYMENT_KT.md |
